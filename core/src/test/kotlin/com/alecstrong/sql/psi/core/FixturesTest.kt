...
class FixturesTest(val dialect: DialectPreset, val name: String, val fixtureRoot: File) {
  ...
  companion object {
    private val dialects = mapOf(
      ...
      DialectPreset.SQLITE_3_24 to arrayOf("src/test/fixtures", "src/test/fixtures_sqlite_3_18", "src/test/fixtures_sqlite_3_24"),
      DialectPreset.SQLITE_3_25 to arrayOf("src/test/fixtures", "src/test/fixtures_sqlite_3_18", "src/test/fixtures_sqlite_3_24", "src/test/fixtures_sqlite_3_25"),
      DialectPreset.SQLITE_3_35 to arrayOf("src/test/fixtures", "src/test/fixtures_sqlite_3_18", "src/test/fixtures_sqlite_3_24", "src/test/fixtures_sqlite_3_25", "src/test/fixtures_sqlite_3_35"),
