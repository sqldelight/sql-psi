...
import com.alecstrong.sql.psi.core.hsql.psi.mixins.ColumnDefMixin as HSqlColumnDefMixin
...
import com.alecstrong.sql.psi.core.sqlite_3_30.SqliteParserUtil as Sqlite_3_30Util
...
enum class DialectPreset {
  ...
  SQLITE_3_30 {
    override fun setup() {
      SQLITE_3_25.setup()
      Sqlite_3_30Util.reset()
      Sqlite_3_30Util.overrideSqlParser()
    }
  },
  SQLITE_3_35 {
    override fun setup() {
  ...
  HSQL {
    override fun setup() {
      ...
      HsqlParserUtil.createElement = {
        when (it.elementType) {
          SqlTypes.COLUMN_DEF -> HSqlColumnDefMixin(it)
          else -> currentElementCreation(it)
        }
      }
    }
